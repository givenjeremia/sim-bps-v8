...
<div class="container-fluid">
  <div class="row mb-2">
    <div class="col-sm-6">
      <h3>Tambah Pasien Ibu Hamil</h3>
    </div>
    <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{url('/ibu_hamil')}}">Pelayanan Ibu Hamil</a></li>
        <li class="breadcrumb-item active">Tambah Pasien Ibu Hamil</li>
      </ol>
    </div>
  </div>
  <div class="row">
  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <FORM method="POST" id="regForm" action="{{ route('layanan-ibu-hamil.store') }}" enctype="multipart/form-data">
            ...
            <div class="tab"><b>RIWAYAT KEHAMILAN PERSALINAN DAN KB:</b>
              ...
              <div class="form-group" id="kehamilan_ke" style="display: none;">
                ...
                <label class="col-sm-1">
                  <input type="number" class="form-control" id="txthamilke" name="txthamilke" oninput="this.className = 'form-control'" value="2" min="2" style="text-align: right;" required>
                </label>
              </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <label class="col-sm-6">
                          <input type="number" style="text-align: right;" class="form-control" id="txtBerat" name="txtBerat[]" placeholder="...KG" oninput="this.className = 'form-control'" required>
                        </label>
                      </div>
                      <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-6">
                        <select class="form-control" id="txtHaid" name="txtHaid" oninput="this.className = 'form-control'">
                          ...
                          <option value="atheis">Teratur</option>
                          <option value="budha">Tidak</option>
                        </select>
                      </label>
                    </div>
                    <div class="form-group">
                      ...
                      <label class="col-sm-6">
                        <div class="input-group">
                          ...
                          <input type="text" id="txtHpht" name="txtHpht" oninput="this.className = 'form-control pull-right datepicker'" class="form-control pull-right datepicker">
                        </div>
                      </label>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-6">
                        <div class="input-group">
                          ...
                          <input type="text" id="txtHpl" name="txtHpl" oninput="this.className = 'form-control pull-right datepicker'" class="form-control pull-right datepicker">
                        </div>
                      </label>
                    </div>
                    <div class="form-group">
                      ...
                      <label class="col-sm-6">
                        <input type="number" min="0" style="text-align: right;" class="form-control" id="txtBBsblmHamil" name="txtBBsblmHamil" placeholder="..." oninput="this.className = 'form-control'" required>
                      </label>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3" style="font-weight: normal;">Mual/Muntah </label>
                      <label class="col-sm-6">
                        <select class="form-control" id="txtSelectMual" name="txtSelectMual" oninput="this.className = 'form-control'" onchange="changeMual(this)">
                    ...
                    <div class="form-group" style="display: none;" id="pendarahan">
                      ...
                      <label class="col-sm-6">
                        <div class="input-group">
                          ...
                          <input type="text" id="txtPendarahansejak" name="txtPendarahansejak" oninput="this.className = 'form-control pull-right datepicker'" class="form-control pull-right datepicker">
                        </div> 
                      </label>
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group"  id="tgl_imunisasi">
                      ...
                      <label class="col-sm-6">
                        <div class="input-group">
                          ...
                          <input type="text" name="tanggal_imunisasi" oninput="this.className = 'form-control datepicker'" class="form-control datepicker" id="tanggal_imunisasi">
                        </div> 
                      </label>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" style="display: none;" id="penyebab_hiv">
                      ...
                      <label class="col-sm-6">
                       <input type="text" name="txt_penyebab_hiv" id="txt_penyebab_hiv" oninput="this.className = 'form-control'" placeholder="..." class="form-control">
                     </label>
                   </div>
                 </div>
               </div>
...
<script>
    ...
    function tambah_anak(){
      ...
      newgbr.innerHTML='<div class="card">'+
                  ...
                  '      <label class="col-sm-3" style="font-weight: normal;">- Berat </label>'+
                  '      <label class="col-sm-6">'+
                  '        <input type="number" style="text-align: right;" class="form-control" id="txtBerat'+id_div+'" name="txtBerat[]" placeholder="...KG" oninput="this.className = \'form-control\'" required>'+
                  '      </label>'+
                  '    </div>'+
                  '    <div class="form-group">'+
                  '      <label class="col-sm-3" style="font-weight: normal;">- Keadaan </label>'+

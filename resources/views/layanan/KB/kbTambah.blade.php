...
<div class="container-fluid">
  ...
  <div class="row mb-2">
    <div class="col-sm-6">
      <h3>Tambah Pasien KB</h3>
    </div>
    <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="#">Home</a></li>
        <li class="breadcrumb-item active"><a href="#">Pelayanan KB</a></li>
        <li class="breadcrumb-item active">Tambah Pasien KB</li>
      </ol>
    </div>
  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row"> 
                        <label class="control-label col-sm-3" for="nama">No. Registrasi</label> 
                        <label class="control-label col-lg-8">
                          <input type="text" class="form-control" id="txtNoregis" name="txtNoregis" required readonly value="<?php echo $noreg; ?>">
                        </label>
                      </div>                      
                    </div>
                  </div>
                ...
                <div class="row">
                    <div class="col-md-6"> 
                      ...
                      <div class="form-group row"> 
                        ...
                        <label class="control-label col-lg-8">
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control datepicker" id="txtTanggalLahiribu" name="txtTanggalLahiribu" required>
                          </div>                
                        </label>
                      </div> 
                      <div class="form-group row"> 
                      ...
                      <div class="form-group row"> 
                        ...
                        <label class="control-label col-lg-8">
                          <input type="text" class="form-control" id="txtPendidikanibu" name="txtPendidikanibu" placeholder="Pendidikan Ibu" required>
                        </label>
                      </div> 
                      <div class="form-group row"> 
                        <label class="control-label col-sm-3">Pekerjaan</label> 
                        <label class="control-label col-lg-8">
                          <input type="text" class="form-control" id="txtPekerjaanibu" name="txtPekerjaanibu" placeholder="Pekerjaan Ibu" required>
                        </label>
                      </div> 
                      <div class="form-group row"> 
                        <label class="control-label col-sm-3">Alamat</label> 
                        <label class="control-label col-lg-8">
                          <input type="text" class="form-control" id="txtAlamatibu" name="txtAlamatibu" placeholder="Alamat Pasien" required>
                        </label>
                      </div>
                      <div class="form-group row"> 
                        <label class="control-label col-sm-3">Kelurahan</label> 
                        <label class="control-label col-lg-8">
                          <input type="text" class="form-control" id="txtKelurahanibu" name="txtKelurahanibu" placeholder="Kelurahan..." autocomplete="off" required>
                        </label>
                      </div>                    
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group row"> 
                        ...
                        <label class="control-label col-lg-8">
                          <input type="text" class="form-control" id="txtNamaayah" name="txtNamaayah" placeholder="Nama Suami" required>
                        </label>
                      </div> 
                      <div class="form-group row"> 
                        <label class="control-label col-sm-3">Tanggal Lahir Suami</label> 
                        <label class="control-label col-lg-6">
                          <div class="input-group">
                            <div class="input-group-prepend">
                              <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                            </div>
                            <input type="text" class="form-control datepicker" id="txtTanggalLahirayah" name="txtTanggalLahirayah">
                          </div>                
                        </label>
                        <label class="control-label col-lg-3">
                          <input type="checkbox" name="chkTgl" id="chkTgl" onchange="check(this)"></input>
                          <label for="chkTgl">Lupa</label>            
                        </label>
                      </div> 
                      <div class="form-group row"> 
                        <label class="control-label col-sm-3">Agama Suami</label> 
                        <label class="control-label col-lg-8">
                      ...
                      <div class="form-group row"> 
                        <label class="control-label col-sm-3">Pendidikan Suami</label> 
                        <label class="control-label col-lg-8">
                          <input type="text" class="form-control" id="txtPendidikanayah" name="txtPendidikanayah" placeholder="Pendidikan Ayah" required>
                        </label>
                      </div> 
                      <div class="form-group row"> 
                        <label class="control-label col-sm-3">Pekerjaan Suami</label> 
                        <label class="control-label col-lg-8">
                          <input type="text" class="form-control" id="txtPekerjaanayah" name="txtPekerjaanayah" placeholder="Pekerjaan Suami" required>
                        </label>
                      </div> 
                      <div class="form-group row"> 
                        <label class="control-label col-sm-3">No. Telp</label> 
                        <label class="control-label col-lg-8">
                          <input type="number" class="form-control" id="txtPhoneibu" name="txtPhoneibu" placeholder="No. Telp (ex:082231656xxx)" required>
                        </label>
                      </div>               
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-lg-10">
                ...
                <div class="form-group">
                  <input type="hidden" name="tipe" id="tipe" value="tambah_pasien"></input>
...
<script type="text/javascript">
  $(document).ready(function(){
    check(document.getElementById("chkTgl"));
    changePrice();
    // Basic
    $('.dropify').dropify();
...
<script>
  ...
  function check(element){
    if(element.checked){
      document.getElementById("txtTanggalLahirayah").required = false;
    }
    else{
      document.getElementById("txtTanggalLahirayah").required = true;
    }
  }
</script>
@endsection
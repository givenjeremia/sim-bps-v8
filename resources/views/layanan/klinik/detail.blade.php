...
<div class="container-fluid">
  ...
  <div class="row mb-2">
    <div class="col-sm-6">
      <h3>Histori Pelayanan Klinik</h3>
    </div>
    <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{url('/klinik')}}">Pelayanan Klinik</a></li>
        <li class="breadcrumb-item active">Histori Pelayanan Klinik</li>
      </ol>
    </div>
  </div>
  <div class="row">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-2 col-4" title="Tambah">
              <a href="{{ url('/klinik-detail-tambah?no_registrasi='.$pasien[0]['no_regis'] ) }}" class="btn btn-block btn-primary btn-sm" id="btnAdd"><i class="fa fa-plus-circle nav-icon"></i> Tambah Histori</a>
            </div>
                  ...
                  <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{$value->keluhan}}</td>
                        <td style="text-align:center;">{{$value->tindakan}}</td>
                        <td>
                       
                          @foreach ($value->obat_layanan as $item)
                          <ul>
                            <li>{{ $item->nama }} {{ $item->pivot->qty }}</li>
                          </ul>
                          @endforeach
                        </td>
                   
                        <td style="text-align: right;">{{number_format($value->transaksi[0]->total_harga,0,",",".")}}</td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>

...
<FORM method="post" action="<?php echo URL::to('/bayi_imunisasi_tambah')?>" name="formPasienBaru" enctype="multipart/form-data">
  <div class="row">
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          <div class="row">
            <div class="col-lg-6">
              <div class="row">
                ...
                <div class="col-lg-6">
                  <?php $ambilNoKar = DB::select('SELECT * FROM layanan_imunisasi ORDER BY id DESC'); 
                  $nokar = '';
                  if($ambilNoKar)

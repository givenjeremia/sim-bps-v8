...
<div class="modal fade" id="modalHapus" role="dialog"> 
  ...
  <div class="modal fade" id="modalHapusTerpilih" role="dialog"> 
    ...
    <!-- tutup modal tambah-->
    <!-- ke history tambah -->
    <FORM method="post" name="formKeHistoryTambah" id="formKeHistoryTambah" action="<?php echo URL::to('/p_ke_history_tambah')?>">
        <input type="hidden" name="_token" value="{!!csrf_token()!!}">
        <input type="hidden" id="tanggalnya" name="tanggalnya">
        <input type="hidden" id="id_layanannya" name="id_layanannya">
        <input type="hidden" id="no_regnya" name="no_regnya">
    </FORM>
    <!-- tutup ke history tambah -->
    <br>
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3>Pengingat Imunisasi Hari Ini</h3>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Pengingat Imunisasi Hari Ini</li>
          </ol>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
          ...
          @section('add_js')
          <script>
            function keTambahHistory(tanggal, id_layanan, noreg)
            {
              document.getElementById('tanggalnya').value = tanggal;
              document.getElementById('id_layanannya').value = id_layanan;
              document.getElementById('no_regnya').value = noreg;
              document.formKeHistoryTambah.submit();
            }

              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                    ...
                    <FORM method="post" action="<?php echo URL::to('/pasien_dewasaImport')?>" enctype="multipart/form-data"> 
                      <div class="form-group">
                      ...
                      <div class="form-group"> 
                        Gunakan file dengan format .xlsx. Download template <a href="<?php echo URL::to('/pasien_dewasaExport/1')?>">disini</a>
                      </div> 
                    </FORM> 
                  </div>
                  <!-- /.tab-pane -->
                  <div class="tab-pane" id="tab_2">
                    ...
                    <FORM method="post" action="<?php echo URL::to('/pasien_dewasaImport')?>" enctype="multipart/form-data"> 
                      ...
                      <div class="form-group"> 
                        Gunakan file dengan format .xlsx. Download template <a href="<?php echo URL::to('/pasien_dewasaExport/2')?>">disini</a>
                      </div> 
                    </FORM> 
                  </div>
                  <!-- /.tab-pane -->

...
<div class="modal-dialog" role="document">
  <div class="modal-content" style="border-radius: 17px;">
    ...
    <div class="modal-body">
      <form method="POST" id="regForm" action="<?php echo URL::to('/karyawanTambah')?>" aria-label="{{ __('Register') }}">
          <!-- @csrf -->
...
<div class="modal-dialog" role="document">
  <div class="modal-content" style="border-radius: 17px;">
    ...
    <div class="modal-body">
      <FORM method="post" id="editForm" action="<?php echo URL::to('/karyawanEdit')?>">
        <div class="form-group row">
...
<div class="modal fade" id="modalHapus" role="dialog" aria-labelledby="favoritesModalLabel"> 
  <div class="modal-dialog" role="document"> 
    <div class="modal-content" style="border-radius: 17px;"> 
      ...
      <div class="modal-body"> 
        <FORM method="post" action="<?php echo URL::to('/karyawanDelete')?>"> 
          <div class="form-group"> 
...
<div class="modal fade" id="modalHapusSemua" role="dialog" aria-labelledby="favoritesModalLabel"> 
  <div class="modal-dialog" role="document"> 
    <div class="modal-content" style="border-radius: 17px;"> 
      ...
      <div class="modal-body"> 
        <FORM method="post" action="<?php echo URL::to('/karyawanDeleteChecked')?>"> 
          <div class="form-group"> 
...
<div class="container-fluid">
  ...
  <?php if(Auth::user()->username == "super_admin"){ ?>
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-sm-12">
                <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                  ...
                  <tbody>
                    @foreach($karyawanArr as $key => $value) 
                    <tr>
                      <?php if(Auth::user()->username == "super_admin"){ ?>
                      <td>
                        <label>
                      ...
                      <td>
                            <div class="form-group">
                              <div>
                                <button data-toggle="modal" data-target="#modalDetail" id="<?php echo 'detail'.$key; ?>" onclick="opendetailmodal(<?php echo "'".$value["id"]."'" ?>);" class="btn btn-info" data-toggle="tooltips" title="Edit" style="width:40px"><i class="fa fa-info"></i></button>
  ...
  <script>
    ...
    function openeditmodal(id){
      var url = <?php echo "'".URL::to('/getDetailKaryawan')."'"; ?>;
      $.ajax({
        type:"GET",
        url:url,
        data:{karyawan_id:id},
        success:function(data){
            ...
            document.getElementById('txtPasswordEdit').value = resp.password;
    ...
    {
      var url = <?php echo "'".URL::to('/getDetailKaryawan')."'"; ?>;
      var admin_active = <?php echo "'".Auth::user()->username."'"; ?>;
      $.ajax({
        type:"GET",
        url:url,
        data:{karyawan_id:id},
        success:function(data){
            ...
            if(admin_active == 'super_admin'){
              ...
              document.getElementById('lblPassword').innerHTML = resp.password;
            }

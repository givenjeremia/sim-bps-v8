...
<div class="container-fluid">
  <div class="row mb-2">
    <div class="col-sm-6">
      <h3>Laporan Kunjungan Persalinan</h3>
    </div>
    <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="#">Home</a></li>
        <li class="breadcrumb-item active">Laporan Kunjungan Persalinan</li>
      </ol>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          <div class="row">
            <div class="col-md-6"> 
              <FORM method="post" action="<?php echo URL::to('/laporan_kunjungan_persalinan/print')?>">
